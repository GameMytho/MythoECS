 ...
 * - components_added/components_changed: tick-based detection
 ...
 * 2. ComponentsAddedAndChanged - Verify components added and changed operations
...
TEST(RegistrarTest, ComponentsAddedAndChanged) {
    registry reg;
